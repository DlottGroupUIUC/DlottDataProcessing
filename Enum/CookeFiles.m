classdef CookeFiles < CMOSFiles %b16 camera images
    properties
    end
    ...
    methods
        function obj = CookeFiles(handles)
            ...
            %with NaN.
            obj.Gain = num2cell(NaN(1,N));
            obj.ExposureTime = num2cell(NaN(1,N));
            for i = 1:N
                obj.ImageMatrix(:,:,i) = obj.readB16(obj.FilePath,obj.FileNames{i});
            end
            obj.Initialized = 1;
        end
    end
